  ...
  <tr>
   ...
   // $sql = "SELECT user_id, user_name, user_password FROM user_info";
	...
	?>
            ...
            <tr>
              <td height="43" class="style2" id="example"><div align="center" style="background-color:#a41034">
                  <table width="100%" height="55px" >
                    <tr>
                      <td width="35%"><form action="" method="post" name="form1" class="style1">
                          <label>To,
                            <input type="text" name="receiver2">
                          </label>
                      </form></td>
		  ...
		  ?>
            ...
            <tr>
                            ...
                            <table width="100%" height="146" border="1">
                              <tr>
                                <td width="50%" height="35" bgcolor="#a41034"><div align="left" class="style7">
                                    <table width="100%" >
                                      <tr>
                                        <td width="46%"><div align="left"><?php echo $to_name; ?></div></td>
                                        <td width="54%"><div align="right"><span class="style5">
                                            <?php 
			  
			  $my_inbox = $_SESSION['user_id'];
			  $sql = "SELECT * FROM messages WHERE receiver = '$my_inbox'";
    		  $result = mysqli_query($conn, $sql);
    		  $num_of_row = mysqli_num_rows($result);
			  echo "Total Message : ". $num_of_row . "<br/>";
			  ...
			  ?>
                                ...
                                <td width="49%" bgcolor="#a41034"><div align="left" class="style7"><?php echo $_SESSION['user_name']; ?></div></td>
                              </tr>
                              <tr>
			  ...
			  $sql = "SELECT * FROM messages WHERE receiver = '$my_inbox' AND sender = '$to_id'";
    		  $result = mysqli_query($conn, $sql);
    		  $num_of_row = mysqli_num_rows($result);
			  ...
			  ?>
                                ...
                                <td width="49%" class="style2"><div align="right" class="style4" style="margin:25px">
                                    <div align="left">
                                      <?php 
			  if(isset($_REQUEST['u_id'])){
			  ...
			  //find out the message that comes to this current id
			  $sql = "SELECT * FROM messages WHERE receiver = '$to_id' AND sender = '$my_inbox'";
    		  $result = mysqli_query($conn, $sql);
    		  $num_of_row = mysqli_num_rows($result);
			  ...
			  ?>
                      ...
                      <tr>
                        ...
                        <td width="51%"><div align="center">
                          <input type="text" name="receiverr" size="25" placeholder = "search by Id" value="<?php	if(isset($_REQUEST['u_id']))	echo $to_name;?>"/>
                        </div>                          </td>
                      </tr>
                      <tr>
          ...
          <td width="17%" colspan="2" bgcolor="#ffffff"><div align="right" class="style4" style="margin:25px">
            <div align="left">
              <?php 
			  if(isset($_REQUEST['u_id'])){
